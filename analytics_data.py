...
def get_analytics_data() -> dict:
    ...
    for i in range(24):
        ...
        for (name, username), info in app_groups.items():
            ...
            if app_duration < 1 and app_snapshot_count > 0: app_duration = 1
            ...
            for pid, p_info in info["pids"].items():
                ...
                if p_duration < 1 and p_snapshot_count > 0: p_duration = 1
                processes.append({
                    "pid": pid,
    ...
    for i in range(7):
        ...
        for name, username, total_score, snapshot_count, max_temp in rows:
            ...
            if duration < 1 and snapshot_count > 0: duration = 1
